Contributing to viptocoin Core
============================

The viptocoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the viptocoin Core project, and is not to be
confused with overall viptocoin Network Protocol consensus changes.

Whether a pull request is merged into viptocoin Core rests with the project merge
...
Patches that change viptocoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the viptocoin consensus, it must have been
...
The project leader is the release manager for each viptocoin Core release.
