...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("viptocoin viptocoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  viptocoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded viptocoin transaction") + "\n" +
                               "  viptocoin-tx [options] -create [commands]   " + _("Create hex-encoded viptocoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded viptocoin transaction
