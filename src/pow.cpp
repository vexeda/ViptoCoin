...
{
    /* current difficulty formula, viptocoin - DarkGravity v3, written by Evan Duffield - evan@dashpay.io */
...
unsigned int GetLegacyNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader* pblock, bool fProofOfStake)
{
    ...
    // viptocoin coin: target change every block
    // viptocoin coin: retarget with exponential moving toward target spacing
    uint256 bnNew;
