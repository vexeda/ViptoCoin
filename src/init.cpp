...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/viptocoin/viptocoin>";
    const std::string URL_WEBSITE = "<https://viptocoin.com/>";
    ...
    return FormatParagraph(strprintf("Copyright (C) %i-%i The Bitcoin Core Developers", 2009, COPYRIGHT_YEAR)) + "\n" +
           "\n" +
           FormatParagraph(strprintf("Copyright (C) %i-%i The Viptocoin Developers", 2022, COPYRIGHT_YEAR)) + "\n" +
           "\n" +
           FormatParagraph(strprintf(_("Please contribute if you find Viptocoin useful. "
