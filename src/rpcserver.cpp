...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop viptocoin server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "viptocoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* viptocoin features */
        {"viptocoin", "masternode", &masternode, true, true, false},
        {"viptocoin", "listmasternodes", &listmasternodes, true, true, false},
        {"viptocoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"viptocoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"viptocoin", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"viptocoin", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"viptocoin", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"viptocoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"viptocoin", "masternodedebug", &masternodedebug, true, true, false},
        {"viptocoin", "startmasternode", &startmasternode, true, true, false},
        {"viptocoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"viptocoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"viptocoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"viptocoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"viptocoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"viptocoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"viptocoin", "mnbudget", &mnbudget, true, true, false},
        {"viptocoin", "preparebudget", &preparebudget, true, true, false},
        {"viptocoin", "submitbudget", &submitbudget, true, true, false},
        {"viptocoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"viptocoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"viptocoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"viptocoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"viptocoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"viptocoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"viptocoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"viptocoin", "checkbudgets", &checkbudgets, true, true, false},
        {"viptocoin", "mnsync", &mnsync, true, true, false},
        {"viptocoin", "spork", &spork, true, true, false},
        {"viptocoin", "getpoolinfo", &getpoolinfo, true, true, false},
...
{
    return "> viptocoin-cli " + methodname + " " + args + "\n";
}
