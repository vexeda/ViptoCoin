...
public:
    CMainParams()
    {
        ...
        nTargetSpacing = 120; // 120 seconds
        nMaturity = 10;
        nMasternodeCountDrift = 20;
        nMaxMoneyOut = 786000000 * COIN;
        ...
        const char* pszTimestamp = "viptocoin is born";
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1633222751;
        genesis.nBits = bnProofOfWorkLimit.GetCompact();
        genesis.nNonce = 8190714;
        ...
        assert(genesis.hashMerkleRoot == uint256("0x32bf8afa595c3450d6eb454b504d4b3c35dc75d1271542df98348f88ca3e69da"));
        assert(hashGenesisBlock == uint256("0x00000c10033e5bea7b68bf07149f66546e10a5c22e05c72de70f39da06eb0bca"));

     
		
	vSeeds.push_back(CDNSSeedData("185.217.92.112","185.217.92.112"));
...
public:
    CTestNetParams()
    {
        ...
        assert(genesis.hashMerkleRoot == uint256("0x32bf8afa595c3450d6eb454b504d4b3c35dc75d1271542df98348f88ca3e69da"));
        assert(hashGenesisBlock == uint256("0x000097dc48443d53a39b29c0020a378503d8c140e00d8993c4557b204f1b3e57"));
...
public:
    CRegTestParams()
    {
        ...
        assert(genesis.hashMerkleRoot == uint256("0x32bf8afa595c3450d6eb454b504d4b3c35dc75d1271542df98348f88ca3e69da"));
        assert(hashGenesisBlock == uint256("0x51ad9c4f46f0ac8b56e084690054221006241c3ce97da02799d3f8621c40ebe8"));
