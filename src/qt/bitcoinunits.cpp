...
QString BitcoinUnits::name(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case viptocoin:
            return QString("tVCC");
        case mECA:
            return QString("mtVCC");
        case uECA:
            return QString::fromUtf8("μtVCC");
        default:
            return QString("???");
        }
    }
...
QString BitcoinUnits::description(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case viptocoin:
            return QString("VCC");
        case mECA:
            return QString("Milli-VCC (1 / 1" THIN_SP_UTF8 "000)");
        case uECA:
            return QString("Micro-VCC (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    } else {
        switch (unit) {
        case viptocoin:
            return QString("TestVCCs");
        case mECA:
            return QString("Milli-TestVCC (1 / 1" THIN_SP_UTF8 "000)");
        case uECA:
            return QString("Micro-TestVCC (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    }
