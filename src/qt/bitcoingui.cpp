                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("ViptoCoin Wallet") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    webmainAction = new QAction(QIcon(":/icons/explorer"), tr("&viptocoin Project"), this);
    webmainAction->setStatusTip(tr("viptocoin Project Website"));
    ...
    facebookAction->setStatusTip(tr("viptocoin Facebook"));
    ...
    twitterAction->setStatusTip(tr("viptocoin Twitter"));
    ...
    discordAction->setStatusTip(tr("viptocoin Discord"));
    ...
    youtubeAction->setStatusTip(tr("viptocoin Youtube"));
    ...
    telegramAction->setStatusTip(tr("viptocoin Telegram"));
    ...
    redditAction->setStatusTip(tr("viptocoin Reddit"));
    ...
    cmcAction->setStatusTip(tr("CoinMarketCap viptocoin"));
    ...
    exchangesAction->setStatusTip(tr("Markets to buy and sell viptocoin Coin (viptocoin)"));
    exchangesAction->setToolTip(exchangesAction->statusTip());
    exchangesAction->setCheckable(true);
    viptocoinBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&viptocoin block explorer"), this);
    viptocoinBlockExplorerAction->setStatusTip(tr("viptocoin blockchain explorer"));
    viptocoinBlockExplorerAction->setToolTip(viptocoinBlockExplorerAction->statusTip());
    viptocoinBlockExplorerAction->setCheckable(true);
    githubAction = new QAction(QIcon(":/icons/github"), tr("&viptocoin Project Github"), this);
    githubAction->setStatusTip(tr("viptocoin Project Github"));
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a viptocoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and viptocoin: URIs)"));
...
//    }
    ...
    connect(viptocoinBlockExplorerAction, SIGNAL(triggered()), this, SLOT(viptocoinBlockExplorerActionClicked()));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About viptocoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about viptocoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for viptocoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your viptocoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified viptocoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a viptocoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the viptocoin Core help message to get a list with possible viptocoin command-line options"));
...
void BitcoinGUI::createMenuBar()
{
    ...
    help->addAction(aboutQtAction);
	  ...
	  QMenu* Links = appMenuBar->addMenu(tr("&Links"));
		...
		Links->addAction(viptocoinBlockExplorerAction);
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("viptocoin Core client") + " " + networkStyle->getTitleAddText();
...
{
	QDesktopServices::openUrl(QUrl("https://www.viptocoin.net"));
}
void BitcoinGUI::facebookActionClicked()
{
        QDesktopServices::openUrl(QUrl("https://www.facebook.com/viptocoin.coin"));
}
void BitcoinGUI::twitterActionClicked()
{
        QDesktopServices::openUrl(QUrl("https://twitter.com/viptocoin4"));
}
...
{
        QDesktopServices::openUrl(QUrl("https://t.me/viptocoincryptocurrency"));
}
...
{
        QDesktopServices::openUrl(QUrl("https://www.reddit.com/user/viptocoin-coin"));
}
void BitcoinGUI::exchangesActionClicked()
{
        QDesktopServices::openUrl(QUrl("https://"));
}
void BitcoinGUI::viptocoinBlockExplorerActionClicked()
{
...
{
	QDesktopServices::openUrl(QUrl("https://github.com/viptocoin/viptocoin/"));
}
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to viptocoin network", "", count));
}
...
{
    QString strTitle = tr("viptocoin Core"); // default title
