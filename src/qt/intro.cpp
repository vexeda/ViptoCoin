...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("viptocoin Core"),
     ...
     * override -datadir in the viptocoin.conf file in the default data directory
     * (to be consistent with viptocoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
