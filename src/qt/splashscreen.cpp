    ...
    QWidget(0, f), curAlignment(0)
{
    ...
    QString copyrightTextViptocoin   = QChar(0xA9)+QString(" %1-%2 ").arg(2022).arg(COPYRIGHT_YEAR) + QString("The Viptocoin developers");
    ...
    // draw copyright stuff
    {
        ...
        pixPaint.drawText(x,y+10,copyrightTextViptocoin);
        pixPaint.drawText(x,y+20,copyrightTextViptocoin);
    }
