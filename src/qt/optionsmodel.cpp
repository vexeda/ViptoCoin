...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nDisplayUnit"))
        settings.setValue("nDisplayUnit", BitcoinUnits::viptocoin);
    ...
    if (!settings.contains("nAnonymizeviptocoinAmount"))
        settings.setValue("nAnonymizeviptocoinAmount", 1000);

    nAnonymizeviptocoinAmount = settings.value("nAnonymizeviptocoinAmount").toLongLong();
...
// Wallet
    ...
    if (settings.contains("nAnonymizeviptocoinAmount"))
        SoftSetArg("-anonymizeviptocoinamount", settings.value("nAnonymizeviptocoinAmount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in viptocoin.cpp during shotdown to also remove the window positions
...
//            return settings.value("fShowMasternodesTab");
        ...
        case AnonymizeviptocoinAmount:
            return QVariant(nAnonymizeviptocoinAmount);
        case Listen:
...
//            break;
        ...
        case AnonymizeviptocoinAmount:
            nAnonymizeviptocoinAmount = value.toInt();
            settings.setValue("nAnonymizeviptocoinAmount", nAnonymizeviptocoinAmount);
            emit anonymizeviptocoinAmountChanged(nAnonymizeviptocoinAmount);
            break;
        case CoinControlFeatures:
