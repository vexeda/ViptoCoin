...
/** Utility functions used by the viptocoin Qt UI.
 */
namespace GUIUtil
{
...
// Render viptocoin addresses in monospace font
...
// Parse "viptocoin:" URI into recipient object, return true on successful parsing
