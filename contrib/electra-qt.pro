...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/viptocoin-cli.cpp \
           src/viptocoin-tx.cpp \
           src/viptocoin.cpp \
           src/db.cpp \
           ...
           src/qt/viptocoin.cpp \
           src/qt/viptocoinstrings.cpp \
...
RESOURCES += src/qt/viptocoin.qrc src/qt/viptocoin_locale.qrc

TRANSLATIONS += src/qt/locale/viptocoin_bg.ts \
                src/qt/locale/viptocoin_de.ts \
                src/qt/locale/viptocoin_en.ts \
                src/qt/locale/viptocoin_es.ts \
                src/qt/locale/viptocoin_fi.ts \
                src/qt/locale/viptocoin_fr.ts \
                src/qt/locale/viptocoin_it.ts \
                src/qt/locale/viptocoin_ja.ts \
                src/qt/locale/viptocoin_pl.ts \
                src/qt/locale/viptocoin_pt.ts \
                src/qt/locale/viptocoin_ru.ts \
                src/qt/locale/viptocoin_sk.ts \
                src/qt/locale/viptocoin_sv.ts \
                src/qt/locale/viptocoin_vi.ts \
                src/qt/locale/viptocoin_zh_CN.ts \
                src/qt/locale/viptocoin_zh_TW.ts
