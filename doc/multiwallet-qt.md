...
In order to support loading of multiple wallets in viptocoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is viptocoin.cpp.
...
Changes to viptocoin.cpp
----------------------
viptocoin.cpp is the entry point into viptocoin-qt, and as such, will require some minor modifications to provide hooks for
